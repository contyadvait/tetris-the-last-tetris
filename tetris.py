...
def play_replay(replay_data):
    ...
    while True:
        ...
        if hit:
            ...
            draw_centered_text(screen, f'You died because you', subtitle_font, WHITE, SCREEN_HEIGHT // 2)
            draw_centered_text(screen, f'got hit by the blocks', subtitle_font, WHITE, SCREEN_HEIGHT // 2 + 15)
...
def main():
    ...
    draw_centered_text(screen, 'Game Over', game_over_font, RED, SCREEN_HEIGHT // 3)
    draw_centered_text(screen, f'Final Score: {game.score}', subtitle_font, WHITE, SCREEN_HEIGHT // 2)
    draw_centered_text(screen, f'P.S. it\'s buggy on purpose!', subtitle_font, WHITE, SCREEN_HEIGHT // 2 + 15)
